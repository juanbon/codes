...
// @namespace      {blocked}
// @author         {Juan Bonifacio}
// @description    {delete all friends blocked}
// @include        *
//	
...
var URLactual = String(window.location);
  ...
  if(URLactual.indexOf("facebook")!= -1){



if($("#objects_container").find(".bd").length >0){

	guardiola = $("#objects_container").find(".bd").html();

		if(guardiola.indexOf("no puede mostrarse ahora")!= -1){
...
dumme = $.trim($("title").html());

if(dumme.search("Error") != -1){
...
dumme2 = $.trim($("title").html());

if(dumme2.search("Iniciar") != -1){
...
/*
$("body").append("<button type='button'  onclick='self.close()'>uuuuuuu</button>");
*/
